...
public class Energizer {
    ...
    public static void addRecipes() {
        PotionBrewing.addMix(Potions.AWKWARD, Items.BEETROOT, ModObjects.VIGOR_POTION);
        PotionBrewing.addMix(ModObjects.VIGOR_POTION, Items.REDSTONE, ModObjects.VIGOR_POTION_LONG);
    }
